...
class Ui_MainWindow(object):
 ...
 ######################################################################################################       
                ...
                self.low_speed = QPushButton("Decrease Speed")
                self.low_speed.clicked.connect(self.low)
                self.low_speed.setStyleSheet("background-color: black; color: white;")
                self.low_speed.setMinimumSize(75, 25)  # Adjust the values as needed
                self.low_speed.setMaximumSize(125, 50)
                self.low_speed.setSizePolicy(QSizePolicy.Expanding, QSizePolicy.Expanding)
...
##################################BUTTONS#####################################################
                ...
                self.verticalLayout_p.addWidget(self.low_speed)
        ...
        def readData(self):
                ...
                self.updatePlot(data_values)
        def updatePlot(self, data_values):
                self.x = 0
                self.x = float(data_values[0])  
                self.label_6.setText(str(self.x))
...
############################################################################################
        ...
        def retranslateUi(self, MainWindow):
                ...
                self.move_right = QPushButton("RIGHT")
                self.move_right.clicked.connect(self.moveright)
                

                self.move_left = QPushButton("LEFT")
                self.move_left.clicked.connect(self.moveleft)
                

                self.high_speed = QPushButton("High Speed")
                self.high_speed.clicked.connect(self.high)
                

                self.low_speed = QPushButton("Low Speed")
                self.low_speed.clicked.connect(self.low)
